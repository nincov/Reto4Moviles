...
import com.example.reto2.databinding.ActivityFormMaps2Binding;
...
public class FormMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Button insertarSuc, consultarsuc, eliminarSuc, actualizarSuc, chooseSuc;
    ...
    private ActivityFormMaps2Binding binding;
    private ActivityFormMapsBinding binding1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding1 = ActivityFormMapsBinding.inflate(getLayoutInflater());
        ...
        insertarSuc = (Button) findViewById(R.id.btnInsertarSucursal);
        eliminarSuc = (Button) findViewById(R.id.btnEliminarSucursal);
        consultarsuc = (Button) findViewById(R.id.btnConsultarSucursal);
        actualizarSuc = (Button) findViewById(R.id.btnActualizarSucursal);
        ...
        insertarSuc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
